...
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x48000560u)

/* IOPINS0_5 Address: CYREG_PRT5_DR Size (bytes): 10 */
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)0x48000568u)

/* IOPINS0_6 Address: CYREG_PRT6_DM0 Size (bytes): 8 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x48000574u)
...
#define BS_PHUB_CFGMEM1_VAL ((const uint8 CYFAR *)0x48000580u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT4_AG, 0x70u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT5_AMUX, 0x07u);
